...
export const ENCOUNTERS = {
  ...
  watersnake: { kind: 'monster', name: 'Watersnake', level: 2, entryNo: 5, maxHp: 4, xpReward: 2, dropTableId: [] },
  fox: { kind: 'monster', name: 'Fox', level: 2, entryNo: 6, maxHp: 5, xpReward: 2, dropTableId: [] },
  moose: { kind: 'monster', name: 'Moose', level: 2, entryNo: 7, maxHp: 12, xpReward: 4, dropTableId: [] },
  blueberry: { kind: 'monster', name: 'Blueberry', level: 2, entryNo: 8, maxHp: 6, xpReward: 6, dropTableId: [] },
  duckJustADuck: {
    kind: 'monster',
  ...
  feralGoat: { kind: 'monster', name: 'Feral Goat', level: 2, entryNo: 11, maxHp: 5, xpReward: 2, dropTableId: [] },
  ruffian: { kind: 'monster', name: 'Ruffian', level: 2, entryNo: 12, maxHp: 10, xpReward: 4, dropTableId: [] },
  ...
  theAuditor: { kind: 'monster', name: 'The Auditor', level: 2, entryNo: 15, maxHp: 9, xpReward: 9, dropTableId: [] },
